...
(defbinstruct midi-note-off-event ()
  (status 0 :type (or (satisfies (unsigned-byte 8) (curry #'eql #x80))
...
(defbinstruct midi-note-on-event ()
  (status 0 :type (or (satisfies (unsigned-byte 8) (curry #'eql #x90))
...
(defbinstruct midi-poly-pressure-event ()
  (status 0 :type (or (satisfies (unsigned-byte 8) (curry #'eql #xA0))
...
(defbinstruct midi-controller-event ()
  (status 0 :type (or (satisfies (unsigned-byte 8) (curry #'eql #xB0))
...
(defbinstruct midi-program-change-event ()
  (status 0 :type (or (satisfies (unsigned-byte 8) (curry #'eql #xC0))
...
(defbinstruct midi-channel-pressure-event ()
  (status 0 :type (or (satisfies (unsigned-byte 8) (curry #'eql #xD0))
...
(defbinstruct midi-pitch-bend-event ()
  (status 0 :type (or (satisfies (unsigned-byte 8) (curry #'eql #xE0))
...
(defbinstruct midi-timing-code-event ()
  (status 0 :type (satisfies (unsigned-byte 8) (curry #'eql #xF1)))
  (code 0 :type (unsigned-byte 8)))

(defbinstruct midi-song-position-pointer-event ()
  (status 0 :type (satisfies (unsigned-byte 8) (curry #'eql #xF2)))
  (lsb 0 :type (unsigned-byte 8))
  (msb 0 :type (unsigned-byte 8)))

(defbinstruct midi-song-select-event ()
  (status 0 :type (satisfies (unsigned-byte 8) (curry #'eql #xF3)))
  (song 0 :type (unsigned-byte 8)))

(defbinstruct midi-tune-request-event ()
  (status 0 :type (satisfies (unsigned-byte 8) (curry #'eql #xF6))))

;;; System real-time message structs

(defbinstruct midi-timing-clock-event ()
  (status 0 :type (satisfies (unsigned-byte 8) (curry #'eql #xF8))))

(defbinstruct midi-start-sequence-event ()
  (status 0 :type (satisfies (unsigned-byte 8) (curry #'eql #xFA))))

(defbinstruct midi-continue-sequence-event ()
  (status 0 :type (satisfies (unsigned-byte 8) (curry #'eql #xFB))))

(defbinstruct midi-stop-sequence-event ()
  (status 0 :type (satisfies (unsigned-byte 8) (curry #'eql #xFC))))

(defbinstruct midi-active-sensing-event ()
  (status 0 :type (satisfies (unsigned-byte 8) (curry #'eql #xFE))))
...
(defbinstruct midi-authorization-sysex-event ()
  (status 0 :type (satisfies (unsigned-byte 8) (curry #'eql #xF7)))
  (len 0 :type vlq-base128-be)
  (data (make-array 0 :element-type '(unsigned-byte 8)) :type (simple-array (unsigned-byte 8) (len))))
